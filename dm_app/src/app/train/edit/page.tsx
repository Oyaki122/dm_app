...
export default function TrainEdit() {
  ...
  const updateTrain = async ()=>{
    const crewRes = fetch(
      `http://user.keio.ac.jp/~ub622319/dm_app2//api/crewRange/${trainObj?.train.train_id}/edit`,
      {
        method: 'POST',
    ...
    const stopsRes = fetch(
      `http://user.keio.ac.jp/~ub622319/dm_app2//api/stops/${trainObj?.train.train_id}/edit`,
      {
        method: 'POST',
        headers: {'Content-Type': 'application/json'},
    ...
    const trainRes = fetch(
      `http://user.keio.ac.jp/~ub622319/dm_app2//api/train_detail/${trainObj?.train.train_id}/update`,
      {
        method: 'POST',
        headers: {'Content-Type': 'application/json'},
        body: JSON.stringify({
